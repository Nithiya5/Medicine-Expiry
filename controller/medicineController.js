...
const getCart = async (req, res) => {
  try {
    ...
    const cartItems = await Cart.find({ userId })
      .populate('medicineId', 'name price imageUrl')
      .sort({ createdAt: -1 });
...
module.exports = {addMedicine,getOneMedicine,updateMedicine,deleteById,getMedicinesByUser,getMedicineByCategory,addToCart,removeFromCart,getCart};
